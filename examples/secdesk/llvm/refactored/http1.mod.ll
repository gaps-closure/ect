; ModuleID = './examples/secdesk/c/refactored/http1.mod.c'
source_filename = "./examples/secdesk/c/refactored/http1.mod.c"
...
@.str.2 = private unnamed_addr constant [79 x i8] c"FATAL: memory allocation error ./examples/secdesk/c/refactored/http1.mod.c:790\00", align 1
...
@.str.85 = private unnamed_addr constant [44 x i8] c"./examples/secdesk/c/refactored/http1.mod.c\00", align 1
...
@.str.92 = private unnamed_addr constant [94 x i8] c"DEBUG (./examples/secdesk/c/refactored/http1.mod.c:718): (HTTP/1,1) throttling client at %.*s\00", align 1
...
@.str.99 = private unnamed_addr constant [76 x i8] c"DEBUG (./examples/secdesk/c/refactored/http1.mod.c:670): HTTP parser error.\00", align 1
...
10:                                               ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.84, i64 0, i64 0), i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.85, i64 0, i64 0), i32 410, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__PRETTY_FUNCTION__.http1_http2websocket, i64 0, i64 0)) #8
  unreachable
...
30:                                               ; preds = %27
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([79 x i8], [79 x i8]* @.str.2, i64 0, i64 0))
  br label %31
...
134:                                              ; preds = %131
  ...
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([94 x i8], [94 x i8]* @.str.92, i64 0, i64 0), i32 %138, i8* %141)
  br label %142
...
16:                                               ; preds = %13
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([76 x i8], [76 x i8]* @.str.99, i64 0, i64 0))
  br label %17
