; ModuleID = './examples/secdesk/c/refactored/fiobj_numbers.mod.c'
source_filename = "./examples/secdesk/c/refactored/fiobj_numbers.mod.c"
...
@.str.7 = private unnamed_addr constant [52 x i8] c"./examples/secdesk/c/refactored/fiobj_numbers.mod.c\00", align 1
...
9:                                                ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.7, i64 0, i64 0), i32 163, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__PRETTY_FUNCTION__.fiobj_float_set, i64 0, i64 0)) #10
  unreachable
