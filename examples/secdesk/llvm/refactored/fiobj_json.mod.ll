; ModuleID = './examples/secdesk/c/refactored/fiobj_json.mod.c'
source_filename = "./examples/secdesk/c/refactored/fiobj_json.mod.c"
...
@.str.3 = private unnamed_addr constant [49 x i8] c"./examples/secdesk/c/refactored/fiobj_json.mod.c\00", align 1
...
@.str.13 = private unnamed_addr constant [74 x i8] c"FATAL: memory allocation error ./examples/secdesk/c/refactored/fio.h:4920\00", align 1
...
17:                                               ; preds = %12, %3
  call void @__assert_fail(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.3, i64 0, i64 0), i32 419, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__PRETTY_FUNCTION__.fiobj_obj2json2, i64 0, i64 0)) #9
  unreachable
