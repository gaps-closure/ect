; ModuleID = './examples/secdesk/c/refactored/fiobject.mod.c'
source_filename = "./examples/secdesk/c/refactored/fiobject.mod.c"
...
@.str.3 = private unnamed_addr constant [74 x i8] c"FATAL: memory allocation error ./examples/secdesk/c/refactored/fio.h:4920\00", align 1
...
48:                                               ; preds = %45
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str.3, i64 0, i64 0))
  br label %49
