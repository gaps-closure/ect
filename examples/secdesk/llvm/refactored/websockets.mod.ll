; ModuleID = './examples/secdesk/c/refactored/websockets.mod.c'
source_filename = "./examples/secdesk/c/refactored/websockets.mod.c"
...
@.str.2 = private unnamed_addr constant [84 x i8] c"FATAL: memory allocation error ./examples/secdesk/c/refactored/websockets.mod.c:333\00", align 1
...
@.str.3 = private unnamed_addr constant [84 x i8] c"FATAL: memory allocation error ./examples/secdesk/c/refactored/websockets.mod.c:635\00", align 1
...
@.str.16 = private unnamed_addr constant [74 x i8] c"FATAL: memory allocation error ./examples/secdesk/c/refactored/fio.h:3313\00", align 1
...
22:                                               ; preds = %19
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str.2, i64 0, i64 0))
  br label %23
...
30:                                               ; preds = %27
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str.3, i64 0, i64 0))
  br label %31
