...
@.str.37 = private unnamed_addr constant [59 x i8] c"FATAL: (http.c:1123) HTTP Client handler allocation failed\00", align 1
...
@.str.40 = private unnamed_addr constant [43 x i8] c"FATAL: memory allocation error http.c:1283\00", align 1
...
@.str.62 = private unnamed_addr constant [66 x i8] c"DEBUG (http.c:2505): HTTP MIME hash storage count/capa: %zu / %zu\00", align 1
...
343:                                              ; preds = %340
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.37, i64 0, i64 0))
  br label %344
...
39:                                               ; preds = %36
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.40, i64 0, i64 0))
  br label %40
...
4:                                                ; preds = %1
  ...
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([66 x i8], [66 x i8]* @.str.62, i64 0, i64 0), i64 %5, i64 %6)
  br label %7
