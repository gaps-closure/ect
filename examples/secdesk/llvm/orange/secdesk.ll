...
@RESPONSE_FORMAT = internal global i8* getelementptr inbounds ([92 x i8], [92 x i8]* @.str.62, i32 0, i32 0), align 8
...
@.str.53 = private unnamed_addr constant [10 x i8] c"secdesk.c\00", section "llvm.metadata"
...
@.str.57 = private unnamed_addr constant [23 x i8] c"Error opening tempfile\00", align 1
@.str.58 = private unnamed_addr constant [37 x i8] c"Error writing image file %s into %s\0A\00", align 1
...
@.str.59 = private unnamed_addr constant [10 x i8] c"%s/%s.png\00", align 1
...
@llvm.global.annotations = appending global [1 x { i8*, i8*, i8*, i32 }] [{ i8*, i8*, i8*, i32 } { i8* bitcast (i32 (%struct.secinput*, i8*)* @process_secinput to i8*), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.61, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.53, i32 0, i32 0), i32 93 }], section "llvm.metadata"
...
define dso_local i32 @main(i32, i8**) #0 {
  ...
  %6 = call i32 (...) @_master_rpc_init()
  %7 = load i32, i32* %4, align 4
  %8 = load i8**, i8*** %5, align 8
  call void @run_secdesk_service(i32 %7, i8** %8)
  ret i32 0
}

declare dso_local i32 @_master_rpc_init(...) #4
...
define internal i32 @process_secinput(%struct.secinput*, i8*) #0 {
  ...
  call void @llvm.var.annotation(i8* %31, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.52, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.53, i32 0, i32 0), i32 100)
  %32 = bitcast [512 x i8]* %9 to i8*
  call void @llvm.var.annotation(i8* %32, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.52, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.53, i32 0, i32 0), i32 100)
  ...
  %37 = call i32 @mkdir(i8* %36, i32 511) #1
  %38 = getelementptr inbounds [512 x i8], [512 x i8]* %9, i64 0, i64 0
  %39 = getelementptr inbounds [256 x i8], [256 x i8]* %8, i64 0, i64 0
  %40 = call i32 (i8*, i8*, ...) @sprintf(i8* %38, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.55, i64 0, i64 0), i8* %39) #1
  %41 = getelementptr inbounds [512 x i8], [512 x i8]* %9, i64 0, i64 0
  %42 = call i32 @mkstemp(i8* %41)
  %43 = call %struct._IO_FILE* @fdopen(i32 %42, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.56, i64 0, i64 0)) #1
  store %struct._IO_FILE* %43, %struct._IO_FILE** %10, align 8
  %44 = load %struct._IO_FILE*, %struct._IO_FILE** %10, align 8
  %45 = icmp ne %struct._IO_FILE* %44, null
  br i1 %45, label %47, label %46

46:                                               ; preds = %2
  call void @perror(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.57, i64 0, i64 0))
  br label %47
...
55:                                               ; preds = %47
  ...
  %59 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %56, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.58, i64 0, i64 0), i8* %57, i8* %58)
  br label %60

60:                                               ; preds = %55, %47
  %61 = load %struct._IO_FILE*, %struct._IO_FILE** %10, align 8
  %62 = call i32 @fclose(%struct._IO_FILE* %61)
  %63 = bitcast [32 x i8]* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %63, i8* align 16 getelementptr inbounds ([32 x i8], [32 x i8]* @__const.process_secinput.tmp2, i32 0, i32 0), i64 32, i1 false)
  ...
  call void @llvm.var.annotation(i8* %91, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.60, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.53, i32 0, i32 0), i32 125)
  ...
  call void @llvm.var.annotation(i8* %95, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.52, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.53, i32 0, i32 0), i32 132)
  %96 = getelementptr inbounds [128 x double], [128 x double]* %18, i64 0, i64 0
  %97 = call i32 (double*, ...) bitcast (i32 (...)* @_rpc_recognize to i32 (double*, ...)*)(double* %96)
  store i32 %97, i32* %19, align 4
  %98 = load i8*, i8** %12, align 8
  %99 = load i8*, i8** %13, align 8
  %100 = load i8*, i8** %14, align 8
  %101 = call i32 @lookup(i8* %98, i8* %99, i8* %100)
  store i32 %101, i32* %20, align 4
  %102 = load i8*, i8** %12, align 8
  call void @free(i8* %102) #1
  %103 = load i8*, i8** %13, align 8
  call void @free(i8* %103) #1
  %104 = load i8*, i8** %14, align 8
  call void @free(i8* %104) #1
  %105 = getelementptr inbounds [512 x i8], [512 x i8]* %9, i64 0, i64 0
  %106 = load i8*, i8** %4, align 8
  %107 = load i32, i32* %19, align 4
  %108 = call i32 @overlay(i8* %105, i8* %106, i32 %107)
  %109 = call i8* @fio_cli_get(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i64 0, i64 0))
  ...
  call void @llvm.memmove.p0i8.p0i8.i64(i8* align 1 %116, i8* align 1 %120, i64 %125, i1 false)
  %126 = getelementptr inbounds [512 x i8], [512 x i8]* %9, i64 0, i64 0
  %127 = call i32 @remove(i8* %126) #1
...
137:                                              ; preds = %133, %130, %60
  %138 = phi i1 [ false, %130 ], [ false, %60 ], [ %136, %133 ]
...
declare dso_local i32 @_rpc_recognize(...) #4
