; ModuleID = './examples/secdesk/c/orange/fiobj_data.mod.c'
source_filename = "./examples/secdesk/c/orange/fiobj_data.mod.c"
...
@.str.5 = private unnamed_addr constant [45 x i8] c"./examples/secdesk/c/orange/fiobj_data.mod.c\00", align 1
...
13:                                               ; preds = %7
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.5, i64 0, i64 0), i32 941, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__PRETTY_FUNCTION__.fiobj_data_assert_dynamic, i64 0, i64 0)) #10
  unreachable
