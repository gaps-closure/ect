; ModuleID = './examples/secdesk/c/orange/http.mod.c'
source_filename = "./examples/secdesk/c/orange/http.mod.c"
...
@.str.37 = private unnamed_addr constant [91 x i8] c"FATAL: (./examples/secdesk/c/orange/http.mod.c:1123) HTTP Client handler allocation failed\00", align 1
...
@.str.40 = private unnamed_addr constant [75 x i8] c"FATAL: memory allocation error ./examples/secdesk/c/orange/http.mod.c:1283\00", align 1
...
@.str.62 = private unnamed_addr constant [98 x i8] c"DEBUG (./examples/secdesk/c/orange/http.mod.c:2505): HTTP MIME hash storage count/capa: %zu / %zu\00", align 1
...
@.str.137 = private unnamed_addr constant [70 x i8] c"FATAL: memory allocation error ./examples/secdesk/c/orange/fio.h:3313\00", align 1
...
343:                                              ; preds = %340
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([91 x i8], [91 x i8]* @.str.37, i64 0, i64 0))
  br label %344
...
39:                                               ; preds = %36
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([75 x i8], [75 x i8]* @.str.40, i64 0, i64 0))
  br label %40
...
20:                                               ; preds = %17
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([70 x i8], [70 x i8]* @.str.137, i64 0, i64 0))
  br label %21
...
4:                                                ; preds = %1
  ...
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([98 x i8], [98 x i8]* @.str.62, i64 0, i64 0), i64 %5, i64 %6)
  br label %7
