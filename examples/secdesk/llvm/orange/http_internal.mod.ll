; ModuleID = './examples/secdesk/c/orange/http_internal.mod.c'
source_filename = "./examples/secdesk/c/orange/http_internal.mod.c"
...
@.str.5 = private unnamed_addr constant [80 x i8] c"DEBUG (./examples/secdesk/c/orange/http_internal.mod.c:72): missing Host header\00", align 1
@.str.6 = private unnamed_addr constant [113 x i8] c"FATAL: (./examples/secdesk/c/orange/http_internal.mod.c:101) Couldn't allocate response object for error report.\00", align 1
...
133:                                              ; preds = %130
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([80 x i8], [80 x i8]* @.str.5, i64 0, i64 0))
  br label %134
...
35:                                               ; preds = %32
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([113 x i8], [113 x i8]* @.str.6, i64 0, i64 0))
  br label %36
