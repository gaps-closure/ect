; ModuleID = './examples/secdesk/c/orange/secdesk.mod.c'
source_filename = "./examples/secdesk/c/orange/secdesk.mod.c"
...
@.str.53 = private unnamed_addr constant [42 x i8] c"./examples/secdesk/c/orange/secdesk.mod.c\00", section "llvm.metadata"
...
@llvm.global.annotations = appending global [1 x { i8*, i8*, i8*, i32 }] [{ i8*, i8*, i8*, i32 } { i8* bitcast (i32 (%struct.secinput*, i8*)* @process_secinput to i8*), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.61, i32 0, i32 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.53, i32 0, i32 0), i32 95 }], section "llvm.metadata"
...
declare dso_local void @_master_rpc_init(...) #4
...
define internal i32 @process_secinput(%struct.secinput*, i8*) #0 {
  ...
  call void @llvm.var.annotation(i8* %32, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.52, i32 0, i32 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.53, i32 0, i32 0), i32 104)
...
60:                                               ; preds = %55, %47
  ...
  call void @llvm.var.annotation(i8* %91, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.60, i32 0, i32 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.53, i32 0, i32 0), i32 131)
  ...
  call void @llvm.var.annotation(i8* %95, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.52, i32 0, i32 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.53, i32 0, i32 0), i32 140)
  %96 = getelementptr inbounds [128 x double], [128 x double]* %18, i64 0, i64 0
  %97 = call i32 @_rpc_recognize(double* %96)
...
declare dso_local i32 @_rpc_recognize(double*) #4
