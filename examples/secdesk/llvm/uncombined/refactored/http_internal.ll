...
133:                                              ; preds = %130
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.5, i64 0, i64 0))
  br label %134
...
35:                                               ; preds = %32
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str.6, i64 0, i64 0))
  br label %36
