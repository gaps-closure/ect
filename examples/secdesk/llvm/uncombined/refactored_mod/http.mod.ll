...
@.str.37 = private unnamed_addr constant [63 x i8] c"FATAL: (http.mod.c:1123) HTTP Client handler allocation failed\00", align 1
...
@.str.40 = private unnamed_addr constant [47 x i8] c"FATAL: memory allocation error http.mod.c:1283\00", align 1
...
@.str.62 = private unnamed_addr constant [70 x i8] c"DEBUG (http.mod.c:2505): HTTP MIME hash storage count/capa: %zu / %zu\00", align 1
...
@.str.137 = private unnamed_addr constant [53 x i8] c"FATAL: memory allocation error ../include/fio.h:3313\00", align 1
...
343:                                              ; preds = %340
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.37, i64 0, i64 0))
  br label %344
...
39:                                               ; preds = %36
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.40, i64 0, i64 0))
  br label %40
...
20:                                               ; preds = %17
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.137, i64 0, i64 0))
  br label %21
...
4:                                                ; preds = %1
  ...
  call void (i8*, ...) @FIO_LOG2STDERR(i8* getelementptr inbounds ([70 x i8], [70 x i8]* @.str.62, i64 0, i64 0), i64 %5, i64 %6)
  br label %7
