...
#else
    xdc_blocking_recv(ssocket, &req_recognize, &t_tag);
#endif /* __LEGACY_XDCOMMS__ */
...
#else
#ifndef __ONEWAY_RPC__
    xdc_asyn_send(psocket, &res_recognize, &o_tag);
#endif /* __ONEWAY_RPC__ */
#endif /* __LEGACY_XDCOMMS__ */
}
...
#else
    xdc_blocking_recv(ssocket, &req_start_recognizer, &t_tag);
#endif /* __LEGACY_XDCOMMS__ */
...
#else
#ifndef __ONEWAY_RPC__
    xdc_asyn_send(psocket, &res_start_recognizer, &o_tag);
#endif /* __ONEWAY_RPC__ */
#endif /* __LEGACY_XDCOMMS__ */
}
...
#else
    xdc_blocking_recv(ssocket, &req_stop_recognizer, &t_tag);
#endif /* __LEGACY_XDCOMMS__ */
...
#else
#ifndef __ONEWAY_RPC__
    xdc_asyn_send(psocket, &res_stop_recognizer, &o_tag);
#endif /* __ONEWAY_RPC__ */
#endif /* __LEGACY_XDCOMMS__ */
}
